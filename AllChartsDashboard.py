...
df1 = pd.read_csv('../Datasets/AT&TPrices.csv')
df2 = pd.read_csv('../Datasets/SpectrumPrices.csv')


# Line Chart
line_df = df2
line_df['Year'] = pd.to_datetime(line_df['Year'])
data_linechart = [go.Scatter(x=line_df['Year'], y=line_df['DefaultPricePerMonth'], mode='lines', name='Price')]

# Multi Line Chart
multiline_df = df2
multiline_df['Year'] = pd.to_datetime(multiline_df['Year'])
trace1_multiline = go.Scatter(x=multiline_df['Year'], y=multiline_df['DefaultPricePerMonth'], mode='lines', name='DefaultPrice')
trace2_multiline = go.Scatter(x=multiline_df['Year'], y=multiline_df['BundlePrice'], mode='lines', name='BundlePrice')
